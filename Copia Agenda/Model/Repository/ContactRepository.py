...
class ContactRepository:
    ...
    def add_contact(self, contact):
        with Context() as context1:
            if len(contact.fechaNacimiento) > 0:
                try: 
                    ...
                    print("Error en la fecha ingresada. Intente nuevamente")
            else:
                try:
    ...
    def update_contact(self, contact):
        with Context() as context1:
            if len(contact.fechaNacimiento) > 0:
                ...
                query = "UPDATE contact SET name = %s, surname = %s, fechaNacimiento = null, email = %s WHERE idcontact = %s AND username = %s"
